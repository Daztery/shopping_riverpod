...
/// See also [getLimitUseCase].
@ProviderFor(getLimitUseCase)
final getLimitUseCaseProvider = AutoDisposeProvider<GetLimitUseCase>.internal(
  getLimitUseCase,
  name: r'getLimitUseCaseProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$getLimitUseCaseHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
/// See also [setLimitUseCase].
@ProviderFor(setLimitUseCase)
final setLimitUseCaseProvider = AutoDisposeProvider<SetLimitUseCase>.internal(
  setLimitUseCase,
  name: r'setLimitUseCaseProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$setLimitUseCaseHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
